...
class ParameterContainer implements Iterator, ArrayAccess, Countable
{
    ...
    const TYPE_LOB = 'lob';
    const TYPE_CURSOR = 'cursor';
    const TYPE_ARRAY_NUM = 'arr_num';
    const TYPE_ARRAY_CHAR = 'arr_char';
    const TYPE_ARRAY_CLOB = 'arr_clob';
    const TYPE_ARRAY_NUM_PG = 'string';
    const TYPE_ARRAY_CHAR_PG = 'string';
    const TYPE_ARRAY_JSON_PG = 'arr_json';
    ...
    public function offsetSet($name, $value, $errata = null, $maxLength = null)
    {
        ...
        if(in_array($errata, [self::TYPE_ARRAY_NUM_PG, self::TYPE_ARRAY_CHAR_PG])){
            if(is_array($value)) {
                $value = '{' . implode(',', $value) . '}';
            }
            $this->data[$name] = $value;
        } else if ($errata == self::TYPE_ARRAY_JSON_PG){
            $binding = '{}';
            if(is_array($value)) {
                $array_json = [];
                ...
                $binding = '{' . implode(',', $array_json) . '}';
            }
            $this->data[$name] = $binding;
        }else{
            $this->data[$name] = $value;
        }
